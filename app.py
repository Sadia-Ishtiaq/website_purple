...
@login_required
def chat():
    """Handle chat messages with rule-based responses"""
    ...
    responses = {
        'glioma': {
            'keywords': ['glioma', 'what is glioma', 'tell me about glioma', 'glioma tumor'],
            'response': "🧠 **Glioma** is a type of tumor that starts in the glial cells of the brain or spine. It's the most common type of primary brain tumor. Symptoms may include headaches, seizures, and cognitive changes. Treatment depends on the grade and location. Would you like to know more about treatment options?"
        },
        'meningioma': {
            'keywords': ['meningioma', 'what is meningioma', 'tell me about meningioma'],
            'response': "🧠 **Meningioma** is a tumor that arises from the meninges - the membranes that surround your brain and spinal cord. Most meningiomas are benign (non-cancerous) and grow slowly. They're more common in women and often found incidentally during scans for other conditions."
        },
        'pituitary': {
            'keywords': ['pituitary', 'pituitary tumor', 'pituitary gland'],
            'response': "🧠 **Pituitary tumors** are abnormal growths in the pituitary gland at the base of the brain. Most are benign and slow-growing. They can affect hormone production, causing various symptoms like headaches, vision problems, fatigue, or hormonal imbalances. Treatment may include medication, surgery, or monitoring."
        },
        'no tumor': {
            'keywords': ['no tumor', 'normal', 'healthy', 'negative'],
            'response': "✅ **No tumor detected** means your MRI scan appears normal with no abnormal growths or masses. This is a good result! Continue with regular checkups as recommended by your doctor. Remember that this AI tool is for assistance only - always consult with your healthcare provider."
        },
        'confidence': {
            'keywords': ['confidence', 'confidence score', 'how confident', 'percentage', 'accuracy'],
            'response': "📊 **Confidence score** shows how certain the AI model is about its prediction. Higher scores (above 90%) indicate high reliability. Lower scores (below 70%) suggest the result should be reviewed by a specialist. Our model achieves 90% overall accuracy on test datasets."
        },
        'mri': {
            'keywords': ['mri', 'scan', 'mri scan', 'magnetic resonance', 'read mri', 'interpret'],
            'response': "🖼️ **About MRI Scans:** MRI (Magnetic Resonance Imaging) uses strong magnetic fields to create detailed images of the brain. Our AI analyzes these images to detect tumors by looking for abnormal tissue growth, shape, density, and contrast patterns. The system classifies findings into four categories: Glioma, Meningioma, Pituitary tumor, or No tumor."
        },
        'next steps': {
            'keywords': ['next steps', 'what to do', 'after detection', 'what now', 'follow up'],
            'response': "🩺 **Next steps after detection:**\n\n1️⃣ Consult with a neurosurgeon or radiologist immediately\n2️⃣ Bring your MRI report and images to the appointment\n3️⃣ Further imaging (contrast MRI, CT) may be needed\n4️⃣ Discuss biopsy if recommended\n5️⃣ Treatment options depend on tumor type, size, and location\n\nRemember: Early detection improves outcomes!"
        },
        'symptoms': {
            'keywords': ['symptom', 'signs', 'feel', 'headache', 'seizure'],
            'response': "⚠️ **Common brain tumor symptoms may include:**\n• Persistent headaches (especially morning)\n• Seizures\n• Vision problems (blurred vision, double vision)\n• Nausea/vomiting\n• Memory or concentration issues\n• Mood or personality changes\n• Weakness on one side of body\n\nNote: These symptoms can also be caused by other conditions. Always consult a doctor for proper evaluation."
        },
        'treatment': {
            'keywords': ['treatment', 'therapy', 'cure', 'surgery', 'radiation', 'chemotherapy'],
            'response': "💊 **Treatment options** depend on tumor type, size, location, and grade:\n\n• **Surgery** - Removal of tumor (craniotomy)\n• **Radiation therapy** - High-energy beams to kill tumor cells\n• **Chemotherapy** - Drugs to stop tumor growth\n• **Targeted therapy** - Drugs that target specific tumor features\n• **Active surveillance** - Monitoring slow-growing benign tumors\n\nYour neurosurgeon/oncologist will recommend the best approach based on your specific case."
        },
        'accuracy': {
            'keywords': ['accuracy', 'how accurate', 'reliable', 'trust'],
            'response': "🎯 **Model Accuracy:** Our ResNet50 model achieves **90% accuracy** on test datasets. Each prediction comes with a confidence score showing reliability for that specific scan. The model was trained on thousands of MRI scans and validated by medical professionals. However, this is a decision-support tool - always confirm with a specialist."
        },
        'hello': {
            'keywords': ['hello', 'hi', 'hey', 'greetings', 'good morning', 'good afternoon'],
            'response': "👋 Hello! I'm your NeuroScan AI assistant. I can help you understand brain tumors, MRI results, confidence scores, and next steps. Feel free to ask me anything about:\n\n• Different tumor types (Glioma, Meningioma, Pituitary)\n• How to interpret your MRI report\n• What confidence scores mean\n• Recommended next steps\n\nHow can I assist you today?"
        },
        'thanks': {
            'keywords': ['thanks', 'thank you', 'appreciate', 'thank'],
            'response': "😊 You're welcome! If you have more questions about brain tumors or MRI results, feel free to ask. I'm here to help! Remember to always consult with healthcare professionals for medical advice."
        },
        'help': {
            'keywords': ['help', 'what can you do', 'capabilities', 'features'],
            'response': "🤖 **I can help you with:**\n\n• Explaining brain tumor types (Glioma, Meningioma, Pituitary)\n• Understanding MRI scan results\n• Interpreting confidence scores\n• Next steps after tumor detection\n• Common symptoms and treatment options\n• General information about brain health\n\nJust ask me a question and I'll do my best to help!"
        }
    }
    
    # Default response if no keywords match
    default_response = "I'm not sure about that. Could you please ask about brain tumors, MRI results, confidence scores, or treatment options? For medical emergencies, please consult a doctor immediately. You can try asking:\n\n• What is Glioma?\n• How to read MRI results?\n• What does confidence score mean?\n• Next steps after detection?"
